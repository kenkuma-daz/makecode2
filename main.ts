...
function 道具箱生成 () {
    ...
    itemBox.add2(ItemKind.Hammer, assets.image`ハンマー`)
    itemBox.add2(ItemKind.Wall, assets.tile`壁タイル`)
    itemBox.add2(ItemKind.Ladder, assets.tile`ハシゴタイル`)
    itemBox.add2(ItemKind.Gun, assets.image`ハンドガン`)
}
